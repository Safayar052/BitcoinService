...
public class Button {
	...
	public String toString() {
		return "Button [name=" + name + ", type=" + type + ", subscription="
				+ subscription + ", price_string=" + price_string
				+ ", price_currency_iso=" + price_currency_iso + ", custom="
				+ custom + ", callback_url=" + callback_url + ", success_url="
				+ success_url + ", cancel_url=" + cancel_url + ", description="
				+ description + ", style=" + style + ", include_email="
				+ include_email + "]";
	}
